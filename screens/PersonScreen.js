...
import { fallbackPersons, fetchPersonDetails, fetchPersonMovies, image342 } from '../API/MovieDb';
...

            {
                loading ? (
                    ...
                    <View>
                        ...
                        >
                            <View className="items-center rounded-full overflow-hidden h-72 w-72 border-2 border-neutral-500">
                                ...
                                <Image
                                    ...
                                    source={{ uri: image342(person?.profile_path) || fallbackPersons }}
                        ...
                        <View className='py-6 mx-4 space-y-2'>
